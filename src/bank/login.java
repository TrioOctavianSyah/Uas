...
public class login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if (vusername.getText().equals("user")) {
        if (vpassword.getText().equals("user")) {
        // Bila Login Sukses Maka Masuk Menu Utama
        new BankATM().show();
        this.dispose(); }
        else {
        // Bila Login Gagal Maka Ulangi Login
        JOptionPane.showMessageDialog(rootPane, "<error> Password Tidak Cocok, Coba Ulang");
        vpassword.setText("");
        vpassword.requestFocus(); }}
        else {
        JOptionPane.showMessageDialog(rootPane, "<error> Username, Coba Ulang");
        vusername.setText("");
        vpassword.setText("");
